...
print("\nWelcome to the ISA simulator! - Designed by <Jacopo Ceccuti, Andrea Fratini and Erik Sanz>")
...
while current_cycle != max_cycles:
    ...
    if instructionMemory.read_opcode(program_counter) == "ADD":
        operand_2 = registerFile.read_register(instructionMemory.read_operand_2(program_counter))
        operand_3 = registerFile.read_register(instructionMemory.read_operand_3(program_counter))
        result = operand_2 + operand_3
        registerFile.write_register(instructionMemory.read_operand_1(program_counter),result)
      
        print("Instruction: ", end='')
        instructionMemory.print_instruction(program_counter)
        print("The current program counter is:" ,program_counter)
        print("The current program cycle is:", current_cycle)
        
        program_counter+=1
        current_cycle+=1
        print("---------------------------------------------------------------")
        
    elif instructionMemory.read_opcode(program_counter) == "SUB":
    ...
    elif instructionMemory.read_opcode(program_counter) == "OR":
        operand_2 = registerFile.read_register(instructionMemory.read_operand_2(program_counter))
        operand_3 = registerFile.read_register(instructionMemory.read_operand_3(program_counter))
        result = operand_2 | operand_3
        registerFile.write_register(instructionMemory.read_operand_1(program_counter),result)
    ...
    elif instructionMemory.read_opcode(program_counter) == "AND":
        operand_2 = registerFile.read_register(instructionMemory.read_operand_2(program_counter))
        operand_3 = registerFile.read_register(instructionMemory.read_operand_3(program_counter))
        result = operand_2 & operand_3
        registerFile.write_register(instructionMemory.read_operand_1(program_counter),result)
    ...
    elif instructionMemory.read_opcode(program_counter) == "NOT":
        operand_2 = registerFile.read_register(instructionMemory.read_operand_2(program_counter))
        result = ~operand_2 
        registerFile.write_register(instructionMemory.read_operand_1(program_counter),result)
    ...
    elif instructionMemory.read_opcode(program_counter) == "LI":
        operand_1 = instructionMemory.read_operand_1(program_counter)
        operand_2 = int(instructionMemory.read_operand_2(program_counter))
        registerFile.write_register(operand_1, operand_2)
    ...
    elif instructionMemory.read_opcode(program_counter) == "LD":
        operand_1 = instructionMemory.read_operand_1(program_counter)
        operand_2 = registerFile.read_register(instructionMemory.read_operand_2(program_counter))
        value = dataMemory.read_data(operand_2)
        registerFile.write_register(operand_1, value)
    ...
    elif instructionMemory.read_opcode(program_counter) == "SD":
        operand_1 = registerFile.read_register(instructionMemory.read_operand_1(program_counter))
        operand_2 = registerFile.read_register(instructionMemory.read_operand_2(program_counter))
        dataMemory.write_data(operand_2, operand_1)
    ...
    elif instructionMemory.read_opcode(program_counter) == "JR":
        print("Instruction: ", end='')
        instructionMemory.print_instruction(program_counter)
        print("The current program counter is:" ,program_counter)
        print("The current program cycle is:", current_cycle)
        ...
        operand_1 = registerFile.read_register(instructionMemory.read_operand_1(program_counter))
        program_counter =  operand_1
        
        current_cycle+=1
        print("---------------------------------------------------------------")
        
    elif instructionMemory.read_opcode(program_counter) == "JEQ":
        print("Instruction: ", end='')
        instructionMemory.print_instruction(program_counter)
        print("The current program counter is:" ,program_counter)
        print("The current program cycle is:", current_cycle)
    ...
    elif instructionMemory.read_opcode(program_counter) == "JLT":
        print("Instruction: ", end='')
        instructionMemory.print_instruction(program_counter)
        print("The current program counter is:" ,program_counter)
        print("The current program cycle is:", current_cycle)
    ...
    elif instructionMemory.read_opcode(program_counter) == "NOP":
        print("Instruction: ", end='')
        instructionMemory.print_instruction(program_counter)
        print("The current program counter is:" ,program_counter)
        print("The current program cycle is:", current_cycle)
    ...
    elif instructionMemory.read_opcode(program_counter) == "END":
        print("Instruction: ", end='')
        instructionMemory.print_instruction(program_counter)
        print("The current program counter is:" ,program_counter)
        print("The current program cycle is:", current_cycle)
        ...
        print("WARNING!! OP Code not valid for this machine")
